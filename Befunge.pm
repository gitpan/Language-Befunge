      ...
      ip: while ( my $ip = shift @ip ) {
          ...
          switch: {
                ...
                $char eq '/' and do {
                    ...
                    $res > 2**31-1 and
                      croak "$file ($x,$y): program overflow while performing division";
                    $res < -2**31 and
                      croak "$file ($x,$y): program underflow while performing division";
                    $ip->spush( $res );
                    last switch;
                };
                ...
                $char eq '%' and do {
                    ...
                    my $res = ( $v2 == 0 ) ? 0 : int($v1 % $v2);
                    $res > 2**31-1 and
                      croak "$file ($x,$y): program overflow while performing remainder";
                    $res < -2**31 and
                      croak "$file ($x,$y): program underflow while performing remainder";
                    $ip->spush( $res );
                    last switch;
                };
                ...
                $char eq ' ' and do {
                    ...
                    $torus->move_ip_forward($ip) 
                      while torus_get_value( $ip->curx, $ip->cury ) == 32;
